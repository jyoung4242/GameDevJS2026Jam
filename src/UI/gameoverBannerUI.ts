...
export class GameOverPanel extends UIPanel {
  lbl1: UILabel | null = null;
  constructor() {
    super(panelConfig);

    this.lbl1 = new gameOverLabelUI();
...
const gameOverLabelUIConfig: UILabelConfig = {
  name: "WaveLabelUI",
  width: 1500,
  height: 300,
  pos: vec(150, 120),
...
export class gameOverLabelUI extends UILabel {
  constructor() {
    super(gameOverLabelUIConfig);
  }
}
